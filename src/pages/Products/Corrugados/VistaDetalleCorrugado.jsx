...
/**
 * Layout compartido del detalle (mismo flujo que Redondos).
 * Cada producto tiene su propia página que pasa estos datos.
 */
export default function VistaDetalleCorrugado({
  nombre,
  imagen,
  tabla,
  altImagen,
    ...
    <section className="relative bg-[#f3f4f6] pb-10 pt-6 sm:pt-8">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mb-4 flex min-w-0 items-center gap-3 sm:mb-5 sm:gap-4">
          <button
            type="button"
            onClick={() => navegar(RUTA_CORRUGADOS)}
            aria-label="Regresar a Corrugados y Trefilados"
          ...
          <div className="min-w-0 flex-1">
            <TituloRutaProductos
              segmentos={[
                ...
                { label: 'Corrugados y Trefilados', to: RUTA_CORRUGADOS },
                { label: nombre },
              ]}
            />
          </div>
