...
import imagenGalvanizados from '../../assets/Clavos.jpg';
import imagenCorrugadosTrefilados from '../../assets/Varilla corrugada.jpg';
import {
  AZUL_PRODUCTOS,
  RUTA_COMERCIALES,
  RUTA_CORRUGADOS,
...
const WHATSAPP_URL =
  'https://wa.me/523339680608?text=Hola,%20quiero%20solicitar%20una%20cotizaci%C3%B3n%20de%20productos';
...
const CATEGORIAS = [
  ...
  {
    nombre: 'Galvanizados',
    imagen: imagenGalvanizados,
    to: RUTA_GALVANIZADOS,
  },
  {
    nombre: 'Corrugados y Trefilados',
    imagen: imagenCorrugadosTrefilados,
    to: RUTA_CORRUGADOS,
  },
];
...
/**
 * Catálogo de categorías de producto (mismo diseño que Comerciales).
 */
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mb-5 sm:mb-6">
          <div className="flex min-w-0 items-center gap-3 sm:gap-4">
            ...
            <div className="min-w-0 flex-1">
              <TituloRutaProductos segmentos={[{ label: 'Productos' }]} />
            </div>
          </div>
          <p className="mt-3 max-w-6xl pl-10 text-left text-sm leading-relaxed text-[#555] sm:pl-12 sm:text-base">
          En Aceros Ocotlán ofrecemos una amplia gama de productos de alta calidad, ideales para diversas aplicaciones.
          Nuestros aceros comerciales son perfectos para usos generales en la construcción y fabricación. Los aceros estructurales proporcionan la resistencia necesaria para proyectos de infraestructura robustos. Disponemos de aceros planos, como láminas y placas, ideales para corte y doblado. Además, contamos con tubulares y tuberías, adecuados para sistemas de conducción y estructuras ligeras. En Aceros Ocotlán, la durabilidad y versatilidad son nuestra prioridad.
          </p>
        </div>
        ...
        <div className="mt-5 flex flex-col items-stretch gap-4 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-center text-sm text-[#666] sm:text-left">
            ...
            <Link to="/#productos" className="font-medium text-[#1a4789] underline underline-offset-2">
              Ir
            </Link>
          </p>
