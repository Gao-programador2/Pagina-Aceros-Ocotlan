...
import { PRODUCTOS_CORRUGADOS, rutaProductoCorrugado } from './corrugadosData.js';

const WHATSAPP_URL =
  'https://wa.me/523339680608?text=Hola,%20quiero%20solicitar%20una%20cotizaci%C3%B3n%20de%20Corrugados%20y%20Trefilados';
...
/**
 * Menú de productos Corrugados y Trefilados.
 */
function CorrugadosTrefiladosPage() {
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="rounded-2xl bg-[#e8eaee] px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3">
            {PRODUCTOS_CORRUGADOS.map((producto) => {
              const clasesBoton =
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-3 flex justify-center">
                    <Link
                      to={rutaProductoCorrugado(producto.slug)}
...
export default CorrugadosTrefiladosPage;
