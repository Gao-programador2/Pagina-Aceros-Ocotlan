...
/**
 * Layout compartido del detalle de Estructurales (mismo flujo que Redondos).
 */
export default function VistaDetalleEstructural({
  nombre,
  imagen,
  tabla,
  altImagen,
    ...
    <section className="relative bg-[#f3f4f6] pb-10 pt-6 sm:pt-8">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mb-4 flex min-w-0 items-center gap-3 sm:mb-5 sm:gap-4">
          <button
            type="button"
            onClick={() => navegar(RUTA_ESTRUCTURALES)}
            aria-label="Regresar a Estructurales"
          ...
          <div className="min-w-0 flex-1">
            <TituloRutaProductos
              segmentos={[
                ...
                { label: 'Estructurales', to: RUTA_ESTRUCTURALES },
                { label: nombre },
              ]}
            />
          </div>
