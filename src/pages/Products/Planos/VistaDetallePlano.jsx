...
/**
 * Layout compartido del detalle de Planos.
 */
export default function VistaDetallePlano({
  nombre,
  imagen,
  tabla,
  altImagen,
    ...
    <section className="relative bg-[#f3f4f6] pb-10 pt-6 sm:pt-8">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mb-4 flex min-w-0 items-center gap-3 sm:mb-5 sm:gap-4">
          <button
            type="button"
            onClick={() => navegar(RUTA_PLANOS)}
            aria-label="Regresar a Planos"
