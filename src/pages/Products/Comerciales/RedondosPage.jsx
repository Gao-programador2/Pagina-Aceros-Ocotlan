...
import imagenTablaRedondos from '../../../assets/Redondos-12.png';
import {
  RUTA_COMERCIALES,
  RUTA_PRODUCTOS,
  TituloRutaProductos,
...
const WHATSAPP_URL =
  'https://wa.me/523339680608?text=Hola,%20quiero%20solicitar%20una%20cotizaci%C3%B3n%20de%20Redondos';
...
/**
 * Detalle del producto Redondos (Comerciales).
 */
function RedondosPage() {
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-8 lg:items-start">
            ...
            <div className="flex min-w-0 flex-col">
              ...
              <div className="mt-5 overflow-hidden rounded-lg">
                <img
                  src={imagenTablaRedondos}
                  alt="Tabla de especificaciones de Redondos"
