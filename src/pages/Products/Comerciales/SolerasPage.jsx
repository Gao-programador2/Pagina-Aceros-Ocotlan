...
import imagenTablaSoleras from '../../../assets/Solera comercial-27.png';
import {
  RUTA_COMERCIALES,
  RUTA_PRODUCTOS,
  TituloRutaProductos,
...
const WHATSAPP_URL =
  'https://wa.me/523339680608?text=Hola,%20quiero%20solicitar%20una%20cotizaci%C3%B3n%20de%20Soleras';
...
/**
 * Detalle del producto Soleras (Comerciales).
 */
function SolerasPage() {
        ...
        <div className="rounded-2xl bg-white px-4 py-5 shadow-sm sm:px-6 sm:py-6 lg:px-8">
          <div className="grid gap-6 lg:grid-cols-2 lg:items-start lg:gap-8">
            <div className="overflow-hidden rounded-xl">
              <img
                src={imagenSoleras}
                alt="Soleras comerciales de acero"
            ...
            <div className="flex min-w-0 flex-col">
              ...
              <div className="mt-5 overflow-hidden rounded-lg">
                <img
                  src={imagenTablaSoleras}
                  alt="Tabla de especificaciones de Solera comercial"
