...
import imagenTablaPolinMonten from '../../../assets/Polin mon-ten-24.png';
import {
  RUTA_COMERCIALES,
  RUTA_PRODUCTOS,
  TituloRutaProductos,
...
const WHATSAPP_URL =
  'https://wa.me/523339680608?text=Hola,%20quiero%20solicitar%20una%20cotizaci%C3%B3n%20de%20Pol%C3%ADn%20Monten';
...
/**
 * Detalle del producto Polín Monten (Comerciales).
 */
        ...
        <div className="rounded-2xl bg-white px-4 py-5 shadow-sm sm:px-6 sm:py-6 lg:px-8">
          <div className="grid gap-6 lg:grid-cols-2 lg:items-start lg:gap-8">
            <div className="overflow-hidden rounded-xl">
              <img
                src={imagenPolinMonten}
                alt="Polín Monten estructural"
            ...
            <div className="flex min-w-0 flex-col">
              ...
              <div className="mt-5 overflow-hidden rounded-lg">
                <img
                  src={imagenTablaPolinMonten}
                  alt="Tabla de especificaciones de Polín Monten"
