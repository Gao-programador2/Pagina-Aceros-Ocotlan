...
const WHATSAPP_URL =
  'https://wa.me/523339680608?text=Hola,%20quiero%20solicitar%20una%20cotizaci%C3%B3n%20de%20%C3%81ngulos';
...
/**
 * Detalle del producto Ángulos (Comerciales).
 */
function AngulosPage() {
        ...
        <div className="rounded-2xl bg-white px-4 py-5 shadow-sm sm:px-6 sm:py-6 lg:px-8">
          <div className="grid gap-6 lg:grid-cols-2 lg:items-start lg:gap-8">
            <div className="overflow-hidden rounded-xl">
              <img
                src={imagenAngulos}
                alt="Ángulos estructurales de acero"
                loading="eager"
                decoding="async"
                fetchPriority="high"
