...
/**
 * Layout compartido del detalle de Galvanizados (mismo flujo que Redondos).
 */
export default function VistaDetalleGalvanizado({
  nombre,
  imagen,
  tabla,
  altImagen,
    ...
    <section className="relative bg-[#f3f4f6] pb-10 pt-6 sm:pt-8">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mb-4 flex min-w-0 items-center gap-3 sm:mb-5 sm:gap-4">
          <button
            type="button"
            onClick={() => navegar(RUTA_GALVANIZADOS)}
            aria-label="Regresar a Galvanizados"
          ...
          <div className="min-w-0 flex-1">
            <TituloRutaProductos
              segmentos={[
                ...
                { label: 'Galvanizados', to: RUTA_GALVANIZADOS },
                { label: nombre },
              ]}
            />
          </div>
