...
const AZUL = '#1a4789';
const WHATSAPP_URL =
  'https://wa.me/523339680608?text=Hola,%20quiero%20solicitar%20una%20cotizaci%C3%B3n%20de%20Fabricaci%C3%B3n%20de%20Pol%C3%ADn';
...
/**
 * Detalle del servicio Fabricación de Polín.
 */
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="rounded-2xl bg-white px-4 py-6 shadow-sm sm:px-8 sm:py-8 lg:px-10">
          ...
          <div className="overflow-hidden rounded-xl">
            <img
              src={imagenPolin}
              alt="Polines fabricados Aceros Ocotlán"
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-2 lg:gap-10">
            ...
            <div className="space-y-6">
              <div>
                ...
                La construcción en México demanda rapidez, por eso en Aceros Ocotlán  contamos con la respuesta a las necesidades de la misma, ofreciendo el servicio  de fabricación de polín a la medida, que consiste en rolar la lámina proveniente  de la cinta a perfil polín estructural, en el largo requerido por el cliente.  
                </p>
                <p className="mt-2 text-sm leading-relaxed text-[#444] sm:text-[0.95rem]">
                Fabricamos polín en forma C, que es el más utilizado, y también fabricamos  polín Z que es reconocido por sus ventajas estructurales.
                </p>
              </div>
              ...
              <div className="overflow-hidden rounded-xl">
                <img
                  src={imagenBeneficiosPolin}
                  alt="Beneficios: ahorro en costo, tiempo y mano de obra en fabricación de polín"
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="mt-2 text-sm leading-relaxed text-[#444] sm:text-[0.95rem]">
                Cuando se entregue el material estará debidamente identificado, ya que éste se  proporcionará en paquetes flejados y por medidas, de acuerdo a las  especificaciones establecidas.  
                </p>
                <p className="mt-2 text-sm leading-relaxed text-[#444] sm:text-[0.95rem]">
                Cada paquete viene rotulado con esta información, lo que permite tener un mejor  control sobre la obra. Para mayor confianza, contamos con los certificados de  calidad de materia prima con los que se realizan los polines.
                </p>
              </div>
              ...
              <div className="overflow-hidden rounded-xl">
                <img
                  src={imagenTablaPolin}
                  alt="Especificaciones de polín formado"
                  className="h-auto w-full object-contain"
                />
              </div>
            </div>
...
export default FabricacionPolinPage;
